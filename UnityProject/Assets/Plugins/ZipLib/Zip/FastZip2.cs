...
{
	/// <summary>
	/// FastZipEvents2 supports all events applicable to <see cref="FastZip">FastZip</see> operations.
	/// </summary>
	public class FastZipEvents2
	{
		...
		public TotalProgressHandler TotalProgress;

		public TotalFinishHandler TotalFinish;
		...
		{
			if ( TotalFinish != null ) {
				TotalFinish(this, !hasFailed);
			}
		}
	}
	
	/// <summary>
	/// FastZip2 provides facilities for creating and extracting zip files.
	/// </summary>
	public class FastZip2
	{
		#region Enumerations
		/// <summary>
		...
		#region Constructors
		/// <summary>
		/// Initialise a default instance of <see cref="FastZip2"/>.
		/// </summary>
		public FastZip2()
		{
		}
		...
		/// <summary>
		/// Initialise a new instance of <see cref="FastZip2"/>
		/// </summary>
		/// <param name="events">The <see cref="FastZipEvents2">events</see> to use during operations.</param>
		public FastZip2(FastZipEvents2 events)
		{
			events_ = events;
		}
		#endregion
        ...
        /// By default the EntryFactory used by FastZip2 will set fhe file size.
        /// </remarks>
		...
		{
			if (zipFile_ == null || extractEnum_ == null)
			{
				return ;
			}
			...
			while (continueRunning_ && extractEnum_.MoveNext())
			{
				...
				doneCount_ += entry.Size;
				if (events_ != null)
				{
					events_.OnTotalProgress(doneCount_, totalCount_);
				}
			}

			if (events_ != null)
			{
				events_.OnTotalFinish();
			}
		}
		#endregion
				...
				if ( continueRunning_ ) {
					try {
						...
						if ( RestoreAttributesOnExtract && entry.IsDOSEntry && (entry.ExternalFileAttributes != -1)) {
							...
							// TODO: FastZip2 - Setting of other file attributes on extraction is a little trickier.
		...
		long totalCount_ = 0;
		long doneCount_ = 0;
		System.Collections.IEnumerator extractEnum_ = null;

...
namespace ICSharpCode.SharpZipLib.Core
{
	...
	/// <summary>
	/// Delegate invoked when a total progress changed.
	/// </summary>
	public delegate void TotalProgressHandler(object sender, long done, long total);

	public delegate void TotalFinishHandler(object sender, bool successed);
	#endregion
